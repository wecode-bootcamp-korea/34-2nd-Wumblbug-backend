...
class Project(TimeStampModel):
    ...
    total_amount    = models.DecimalField(max_digits=9, decimal_places=2, default=0, null=True)
    price           = models.DecimalField(max_digits=7, decimal_places=2, default=0, null=True)
    thumbnail       = models.URLField(max_length=150, null=True)
    pk_uri          = models.CharField(max_length=50, unique=True, null=True)
    target_amount   = models.DecimalField(max_digits=9, decimal_places=2, default=0, null=True)
